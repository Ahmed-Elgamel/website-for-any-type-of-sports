...
namespace M3_V1.Controllers
{
    public class ClubRepresentativeController : Controller
    {
        ...
        SqlConnection conn = new SqlConnection(@"Data Source=localhost,1433;Initial Catalog=M2_;User=SA;Password=MyPasswordIsStrong123;Trusted_Connection=False;Encrypt=False;");
        ...
        public IActionResult sendRequest1(String? stadiumNAME, DateTime? time)
        {
            ...
            return RedirectToAction("ViewAllAvailableStadiums1",new { time = time });
        ...
        public IActionResult ViewAllAvailableStadiums1(DateTime? time)
        {
            MyModel model;
            try
            {
